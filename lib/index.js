...
export default class Leylim extends Bus {
   ...
   */
  init() {
    const {components = [] , el, rowList = [], buttons, customEditorButtons = []} = this.options;
    if(!components.length) throw new Error("Can you give me components? please! If you don't have an idea; https://github.com/abdullah/leylim ");
